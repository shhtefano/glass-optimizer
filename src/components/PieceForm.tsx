  ...
  return (
    <div className="glass-panel rounded-2xl p-4 sm:p-5 shadow-lg border border-white/5 flex-grow flex flex-col h-full min-h-0 relative overflow-hidden">
      ...
      <form onSubmit={handleAddPiece} className="space-y-3.5 shrink-0">
        <div>
          ...
          <input
            ...
            className="w-full glass-input rounded-xl px-4 py-2 text-white text-sm"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full glass-input rounded-xl px-4 py-2 text-white text-sm font-semibold font-mono"
          ...
          <div>
            ...
            <div className="flex items-center rounded-xl bg-slate-900 border border-white/10 overflow-hidden h-9">
              ...
              <input
                ...
                className="w-full bg-transparent text-center text-white text-sm focus:outline-none py-1 border-0 ring-0 font-semibold font-mono"
              />
              <button
                type="button"
        ...
        {errorMsg && (
          <div className="flex items-start gap-2 text-xs text-red-400 bg-red-500/10 border border-red-500/20 rounded-xl p-2.5">
        ...
        <div className="flex gap-2 pt-1">
          {editingId && (
            <button
              ...
              className="flex-1 bg-white/5 hover:bg-white/10 text-gray-300 rounded-xl py-2 font-semibold text-xs transition-all border border-white/5"
            >
              Annulla
            </button>
          )}
          <button
            type="submit"
            className={`flex-[2] flex items-center justify-center gap-1.5 rounded-xl py-2 font-bold text-xs uppercase tracking-wider transition-all shadow-md ${editingId
      ...
      <div className="flex-1 min-h-0 flex flex-col">
        {pieces.length === 0 ? (
          <div className="text-center py-8 text-gray-500 border border-dashed border-white/5 rounded-2xl flex flex-col justify-center items-center flex-grow bg-slate-900/10">
            <p className="text-xs font-semibold">Nessun pezzo inserito.</p>
            <p className="text-[10px] mt-1 text-gray-500 max-w-[180px] mx-auto leading-normal">Inserisci le dimensioni del pezzo sopra per aggiungerlo alla lista di taglio.</p>
          </div>
        ) : (
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <div className="flex items-center bg-slate-900/60 border border-white/10 rounded-lg overflow-hidden h-7">
                    <button
                      ...
                      className="px-2 text-gray-400 hover:text-white transition-colors text-xs font-bold"
                    >
                      -
                    </button>
                    <span className="px-1 text-white text-[11px] font-bold min-w-4 text-center font-mono">
                      {piece.quantity}
                    </span>
                    <button
                      type="button"
      ...
      <button
        ...
        className="mt-4 relative group w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:to-pink-600 disabled:opacity-40 disabled:pointer-events-none text-white rounded-xl py-3 font-bold text-xs uppercase tracking-wider shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden shrink-0 h-10"
      >
        {isCalculating ? (
          <>
